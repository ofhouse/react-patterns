// Could be removed when the following pull request is merged
// @see: https://github.com/reach/reach-ui/pull/150
...
declare module '@reach/menu-button' {
  ...
  export type MenuLinkProps<T extends SupportedMenuLinkComponent> = ResolvedMenuLinkProps<T> & {
    to?: string;
    onKeyDown?: (e: React.KeyboardEvent<HTMLElement>) => void;
    onClick?: (e: React.MouseEvent<HTMLElement>) => void;
